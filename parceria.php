...
<section class="container_parceiros">
    <?php foreach ($dadosParceria as $parceria): ?>
        ...
        <div>
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d14723.269476910966!2d-47.64496762320311!3d-22.697841630701475!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1spt-BR!2sbr!4v1700010459675!5m2!1spt-BR!2sbr" width="350" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        </div>
    <?php endforeach; ?>
</section>
<footer>
    ...
    <div class="redes_footer">
        ...
        <a href="https://www.facebook.com/luzecorfestas"> <img class="iconFacebook_footer" src="./ImagensSite-LuzeCor/Fotos/FAce.png" alt="iconFacebook_footer"></a>
        <a href="https://www.instagram.com/luz_e_cor_festas/"> <img class="iconInstagram_footer" src="./ImagensSite-LuzeCor/Fotos/Insta.png" alt="iconInstagram_footer"></a>
        </div>
    </div>
</footer>
</body>
